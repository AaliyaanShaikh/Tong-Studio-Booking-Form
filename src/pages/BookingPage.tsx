        ...
        >
          ...
          <button
            ...
            onClick={() => {
              ...
              setStep(1);
              setStudioIndex(0);
              setBooking({ setup: '', date: '', timing: '', addons: [], extraRequests: '', name: '', email: '', phone: '' });
            }}
    ...
    <div className="min-h-screen bg-alabaster relative">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 pt-[max(1.75rem,env(safe-area-inset-top))] md:pt-12 pb-5 sm:pb-6 md:pb-8 px-4 sm:px-6 md:px-12 transition-colors ${
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <button
            type="button"
            onClick={() => { setStep(1); setStudioIndex(0); setBooking((b) => ({ ...b, setup: FEATURED_STUDIOS[0].id })); }}
        ...
        {step < 4 && (
          <div className="flex flex-col items-center gap-4 mt-6 sm:mt-8">
            <div className="flex flex-row gap-2 sm:gap-4 w-full">
              <button
                type="button"
                onClick={() => (step === 1 ? (setStep(1), setStudioIndex(0), setBooking((b) => ({ ...b, setup: FEATURED_STUDIOS[0].id }))) : setStep((s) => s - 1))}
